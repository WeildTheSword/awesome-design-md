...
async function main() {
  ...
  switch (command) {
    ...
    case undefined: {
      ...
      console.log('');
      console.log(`    ${dim('$')} awesome-ui fetch gradient-wave`);
      console.log(`    ${dim('$')} awesome-ui list`);
      console.log(`    ${dim('$')} awesome-ui search particles`);
      console.log(`    ${dim('$')} awesome-ui list --category=backgrounds`);
      console.log('');
      console.log(`  ${dim('Browse components at')} ${cyan('https://github.com/VoltAgent/awesome-design-md')}`);
      console.log('');
      break;
    }
    ...
    default: {
      ...
      console.log(`  ${dim('Run')} awesome-ui --help ${dim('to see available commands.')}`);
      console.log('');
    }
  }
}
